...
public class CustomTraceHandlerInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// System.out.println("interceptor - param:
		// "+param.getMethod().getName());
	...
	// getTracer().addTag(getTraceKeys().getMvc().getControllerMethod(),
	// methodName);
	...
	// + span);
	// }
	// getTracer().addTag(getTraceKeys().getMvc().getControllerClass(),
	// className);
	// }
